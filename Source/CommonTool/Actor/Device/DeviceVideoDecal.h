 ...
 */
UCLASS()
class COMMONTOOL_API ADeviceVideoDecal : public ABaseDevice
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, Category="CommonLibrary|MediaPlayer")
...
public:
	UPROPERTY(EditAnywhere,BlueprintReadWrite,Category="CommonLibrary|MediaPlayer")
