...
void UJsonToolLibrary::GetFloatFromJsonString(const FString& JsonString, const FString& Key, float& Value)
{
	...
	if (TSharedPtr<FJsonObject> JsonObject = GetJsonObjectFromJsonString(JsonString))
	{
		Result = JsonObject->GetNumberField(Key);
	}
	Value = Result;
}
...
void UJsonToolLibrary::GetDoubleNumFromJsonString(const FString& JsonString, const FString& Key, double& Value)
{
	double Result = -1;
...
void UJsonToolLibrary::SetDoubleNumFromJsonString(const FString& JsonString, const FString& Key, const double& Value,
	FString& RsultJsonString)
{
	if (TSharedPtr<FJsonObject> JsonObject = GetJsonObjectFromJsonString(JsonString))
	{
...
void UJsonToolLibrary::GetStringArrayFromJsonString(const FString& JsonString, const FString& Key,
	TArray<FString>& JsonStringArray)
{
	TArray<FString> Result;
