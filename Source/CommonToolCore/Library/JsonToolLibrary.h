 ...
 */
UCLASS()
class COMMONTOOLCORE_API UJsonToolLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="CommonToolCore|Json")
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="CommonToolCore|Json")
	static void GetDoubleNumFromJsonString(const FString& JsonString, const FString& Key, double& Value);

	UFUNCTION(BlueprintCallable, Category="CommonToolCore|Json")
	static void SetDoubleNumFromJsonString(const FString& JsonString, const FString& Key, const double& Value,
									   FString& RsultJsonString);
	...
	UFUNCTION(BlueprintCallable, Category="CommonToolCore|Json")
	static void GetStringArrayFromJsonString(const FString& JsonString, const FString& Key,
												 TArray<FString>& JsonStringArray);
	UFUNCTION(BlueprintCallable, Category="CommonToolCore|Json")
