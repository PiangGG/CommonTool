...
UCLASS()
class COMMONTOOLCORE_API USimulatedTrainingSubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	//初始化需要完成的任务步骤
	UFUNCTION(BlueprintCallable, Category = "CommonToolCore:SimulatedTrainingSubsystem")
