...
namespace CommonToolTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(State_Training, "State.Training")
	UE_DEFINE_GAMEPLAY_TAG(State_DeviceManager, "State.DeviceManager")
	...
	UE_DEFINE_GAMEPLAY_TAG(State_Emergency, "State.Emergency")
	UE_DEFINE_GAMEPLAY_TAG(State_AI, "State.AI")
	UE_DEFINE_GAMEPLAY_TAG(State_Null, "State.Null")
	UE_DEFINE_GAMEPLAY_TAG(State_SkylightOperation, "State.SkylightOperation")
	...
	UE_DEFINE_GAMEPLAY_TAG(OperationState_1, "OperationState.1")
	UE_DEFINE_GAMEPLAY_TAG(OperationState_2, "OperationState.2")
	...
	UE_DEFINE_GAMEPLAY_TAG(DialogState_Quit, "DialogState.Quit")
	...
	UE_DEFINE_GAMEPLAY_TAG(DialogState_Alarm, "DialogState.Alarm")
	UE_DEFINE_GAMEPLAY_TAG(DialogState_Monitor, "DialogState.Monitor")
	UE_DEFINE_GAMEPLAY_TAG(DialogState_Search, "DialogState.Search")
	UE_DEFINE_GAMEPLAY_TAG(DialogState_StationDocument, "DialogState.StationDocument")
	UE_DEFINE_GAMEPLAY_TAG(DialogState_Introductiont, "DialogState.Introductiont")
	
	UE_DEFINE_GAMEPLAY_TAG(Position_Type_Positioning, "Position.Type.Positioning")
	UE_DEFINE_GAMEPLAY_TAG(Position_Type_WiringDiagram, "Position.Type.WiringDiagram")
	...
	UE_DEFINE_GAMEPLAY_TAG(UserState_AutoRoam, "UserState.AutoRoam"); //自动漫游
	...
	UE_DEFINE_GAMEPLAY_TAG(UIState_Show,	 "UIState.Show") //ui状态
	UE_DEFINE_GAMEPLAY_TAG(UIState_Hide,	 "UIState.Hide") //ui状态

	UE_DEFINE_GAMEPLAY_TAG(Weather_Clear_Skies, "Weather.Clear.Skies")
	UE_DEFINE_GAMEPLAY_TAG(Weather_Cloudy, "Weather.Cloudy")
	UE_DEFINE_GAMEPLAY_TAG(Weather_Foggy, "Weather.Foggy")
	UE_DEFINE_GAMEPLAY_TAG(Weather_Overcast, "Weather.Overcast")
	UE_DEFINE_GAMEPLAY_TAG(Weather_Partly_Cloudy, "Weather.Partly.Cloudy")
	UE_DEFINE_GAMEPLAY_TAG(Weather_Rain, "Weather.Rain")
	UE_DEFINE_GAMEPLAY_TAG(Weather_Rain_Light, "Weather.Rain.Light")
	UE_DEFINE_GAMEPLAY_TAG(Weather_Rain_Thunderstorm, "Weather.Rain.Thunderstorm")
	UE_DEFINE_GAMEPLAY_TAG(Weather_Sand_Dust_Calm, "Weather.Sand.Dust.Calm")
	UE_DEFINE_GAMEPLAY_TAG(Weather_Sand_Dust_Storm, "Weather.Sand.Dust.Storm")
	UE_DEFINE_GAMEPLAY_TAG(Weather_Snow, "Weather.Snow")
	UE_DEFINE_GAMEPLAY_TAG(Weather_Snow_Blizzard, "Weather.Snow.Blizzard")
	UE_DEFINE_GAMEPLAY_TAG(Weather_Snow_Light, "Weather.Snow.Light")
}

CommonToolCoreTags::CommonToolCoreTags()
{
