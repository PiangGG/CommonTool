...
class COMMONTOOLCORE_API UCameraMode_ThirdPerson : public UCameraMode
{
	GENERATED_BODY()
...
protected:
	...
	void PreventCameraPenetration(const class AActor& ViewTarget, const FVector& SafeLoc, FVector& CameraLoc,
	...
	virtual void ZoomAway() override;
