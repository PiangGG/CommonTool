...
UCLASS()
class COMMONTOOLGIZMO_API ACommonGizmoTransform : public AActor, public ICommonGizmoInterface ,public IIInteractive
{
	GENERATED_BODY()
...
public:
	...
	virtual void OnPointerDrag_Implementation(UPrimitiveComponent* Component,const FVector&RayStart,const FVector&RayEnd) override;
	virtual bool OnPointerDown_Implementation(UPrimitiveComponent* Component,const FVector&RayStart,const FVector&RayEnd) override;
	...
	UFUNCTION(BlueprintCallable, Category="Common|Gizmo")
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "CommonToolCore|Gizmo", meta = (AllowPrivateAccess = "true"))
