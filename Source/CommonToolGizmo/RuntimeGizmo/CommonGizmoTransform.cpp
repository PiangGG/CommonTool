...
#include "CommonToolCore/Interface/DeviceInterface.h"
...
ACommonGizmoTransform::ACommonGizmoTransform()
{
	...
	SM_AngleHelper = LoadObject<UStaticMesh>(
		nullptr, TEXT("/CommonTool/TransformGizmo/Meshes/SM_AngleHelper.SM_AngleHelper"));
	SM_LineHelper = LoadObject<UStaticMesh>(
		nullptr, TEXT("/CommonTool/TransformGizmo/Meshes/SM_LineHelper.SM_LineHelper"));
	SM_PlaneHandle = LoadObject<UStaticMesh>(
		nullptr, TEXT("/CommonTool/TransformGizmo/Meshes/SM_PlaneHandle.SM_PlaneHandle"));
	SM_RotationHandle = LoadObject<UStaticMesh>(
		nullptr, TEXT("/CommonTool/TransformGizmo/Meshes/SM_RotationHandle.SM_RotationHandle"));
	SM_RotationHandleCollision = LoadObject<UStaticMesh>(
		nullptr, TEXT(
			"/CommonTool/TransformGizmo/Meshes/SM_RotationHandleCollision.SM_RotationHandleCollision"));
	SM_ScaleHandle = LoadObject<UStaticMesh>(
		nullptr, TEXT("/CommonTool/TransformGizmo/Meshes/SM_ScaleHandle.SM_ScaleHandle"));
	SM_ScaleHelper_Cube = LoadObject<UStaticMesh>(
		nullptr, TEXT("/CommonTool/TransformGizmo/Meshes/SM_ScaleHelper_Cube.SM_ScaleHelper_Cube"));
	SM_ScaleHelper_Plane = LoadObject<UStaticMesh>(
		nullptr, TEXT("/CommonTool/TransformGizmo/Meshes/SM_ScaleHelper_Plane.SM_ScaleHelper_Plane"));
	SM_ScaleHelper_UnitLine = LoadObject<UStaticMesh>(
		nullptr, TEXT("/CommonTool/TransformGizmo/Meshes/SM_ScaleHelper_UnitLine.SM_ScaleHelper_UnitLine"));
	SM_ScreenRotationHandle = LoadObject<UStaticMesh>(
		nullptr, TEXT("/CommonTool/TransformGizmo/Meshes/SM_ScreenRotationHandle.SM_ScreenRotationHandle"));
	SM_ScreenTranslationHandle = LoadObject<UStaticMesh>(
		nullptr, TEXT(
			"/CommonTool/TransformGizmo/Meshes/SM_ScreenTranslationHandle.SM_ScreenTranslationHandle"));
	SM_TrackballRotationHandle = LoadObject<UStaticMesh>(
		nullptr, TEXT(
			"/CommonTool/TransformGizmo/Meshes/SM_TrackballRotationHandle.SM_TrackballRotationHandle"));
	SM_TranslationHandle = LoadObject<UStaticMesh>(
		nullptr, TEXT("/CommonTool/TransformGizmo/Meshes/SM_TranslationHandle.SM_TranslationHandle"));
	SM_UniformScaleHandle = LoadObject<UStaticMesh>(
		nullptr, TEXT("/CommonTool/TransformGizmo/Meshes/SM_UniformScaleHandle.SM_UniformScaleHandle"));

	M_AngleHelper = LoadObject<UMaterialInterface>(
		nullptr, TEXT("/CommonTool/TransformGizmo/Materials/M_AngleHelper.M_AngleHelper"));
	M_GizmoAxis = LoadObject<UMaterialInterface>(
		nullptr, TEXT("/CommonTool/TransformGizmo/Materials/M_GizmoAxis.M_GizmoAxis"));
	M_Hidden = LoadObject<UMaterialInterface>(
		nullptr, TEXT("/CommonTool/TransformGizmo/Materials/M_Hidden.M_Hidden"));
	M_ScreenRotation = LoadObject<UMaterialInterface>(
		nullptr, TEXT("/CommonTool/TransformGizmo/Materials/M_ScreenRotation.M_ScreenRotation"));
	MI_Ghost = LoadObject<UMaterialInterface>(
		nullptr, TEXT("/CommonTool/TransformGizmo/Materials/MI_Ghost.MI_Ghost"));
	MI_Hovered = LoadObject<UMaterialInterface>(
		nullptr, TEXT("/CommonTool/TransformGizmo/Materials/MI_Hovered.MI_Hovered"));
	MI_Rotation_Hovered = LoadObject<UMaterialInterface>(
		nullptr, TEXT("/CommonTool/TransformGizmo/Materials/MI_Rotation_Hovered.MI_Rotation_Hovered"));
	MI_Rotation_XAxis = LoadObject<UMaterialInterface>(
		nullptr, TEXT("/CommonTool/TransformGizmo/Materials/MI_Rotation_XAxis.MI_Rotation_XAxis"));
	MI_Rotation_YAxis = LoadObject<UMaterialInterface>(
		nullptr, TEXT("/CommonTool/TransformGizmo/Materials/MI_Rotation_YAxis.MI_Rotation_YAxis"));
	MI_Rotation_ZAxis = LoadObject<UMaterialInterface>(
		nullptr, TEXT("/CommonTool/TransformGizmo/Materials/MI_Rotation_ZAxis.MI_Rotation_ZAxis"));
	MI_ScreenRotation_Hovered = LoadObject<UMaterialInterface>(
		nullptr,
		TEXT("/CommonTool/TransformGizmo/Materials/MI_ScreenRotation_Hovered.MI_ScreenRotation_Hovered"));
	MI_XAxis = LoadObject<UMaterialInterface>(
		nullptr, TEXT("/CommonTool/TransformGizmo/Materials/MI_XAxis.MI_XAxis"));
	MI_XAxis_Ghost = LoadObject<UMaterialInterface>(
		nullptr, TEXT("/CommonTool/TransformGizmo/Materials/MI_XAxis_Ghost.MI_XAxis_Ghost"));
	MI_XYZAxis = LoadObject<UMaterialInterface>(
		nullptr, TEXT("/CommonTool/TransformGizmo/Materials/MI_XYZAxis.MI_XYZAxis"));
	MI_YAxis = LoadObject<UMaterialInterface>(
		nullptr, TEXT("/CommonTool/TransformGizmo/Materials/MI_YAxis.MI_YAxis"));
	MI_YAxis_Ghost = LoadObject<UMaterialInterface>(
		nullptr, TEXT("/CommonTool/TransformGizmo/Materials/MI_YAxis_Ghost.MI_YAxis_Ghost"));
	MI_ZAxis = LoadObject<UMaterialInterface>(
		nullptr, TEXT("/CommonTool/TransformGizmo/Materials/MI_ZAxis.MI_ZAxis"));
	MI_ZAxis_Ghost = LoadObject<UMaterialInterface>(
		nullptr, TEXT("/CommonTool/TransformGizmo/Materials/MI_ZAxis_Ghost.MI_ZAxis_Ghost"));
...
void ACommonGizmoTransform::OnPointerDrag_Implementation(UPrimitiveComponent* Component,const FVector&RayStart,const FVector&RayEnd)
{
	HandlePointerDrag(Component, RayStart, RayEnd);
}

bool ACommonGizmoTransform::OnPointerDown_Implementation(UPrimitiveComponent* Component,const FVector&RayStart,const FVector&RayEnd)
{
...
void ACommonGizmoTransform::HandlePointerEnter(UPrimitiveComponent* Component)
{
	...
	{
		UPrintToolLibrary::Debug(FString::Printf(TEXT("HandlePointerEnter::%s"),*Component->GetName()));
	}
...
void ACommonGizmoTransform::HandlePointerLeave(UPrimitiveComponent* Component)
{
	...
	if (UPrintToolLibrary::PrintDebug())
	{
		UPrintToolLibrary::Debug(FString::Printf(TEXT("HandlePointerLeave::%s"),*Component->GetName()));
	}
	FCommonGizmoHandle CommonGizmoHandle = GizmoHandleMap.FindRef(Component);
	if (CommonGizmoHandle.TransformMode == CommonToolTags::TransformMode_Translation || CommonGizmoHandle.TransformMode
		== CommonToolTags::TransformMode_Scale)
...
void ACommonGizmoTransform::BeginPlay()
{
	...
	GizmoManager = GetWorld()->GetSubsystem<UGizmoManager>();
	if (GizmoManager)
	{
		GizmoManager->OnChangeTransformMode.AddDynamic(this, &ThisClass::SetTransformMode);
		GizmoManager->OnChangeAlignSpace.AddDynamic(this, &ThisClass::SetAlignSpace);
		GizmoManager->OnActivateGizmo.AddDynamic(this, &ThisClass::OnActivateGizmo);
	}
}
