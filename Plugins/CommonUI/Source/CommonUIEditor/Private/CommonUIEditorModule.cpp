...
void FCommonUIEditorModule::StartupModule()
{
	...
	TSharedPtr<FCommonAssetTypeActions_GenericInputActionDataTable> InputDataTableAction = MakeShared<
		FCommonAssetTypeActions_GenericInputActionDataTable>();
	...
	PropertyModule.RegisterCustomPropertyTypeLayout(FUITag::StaticStruct()->GetFName(),
	                                                FOnGetPropertyTypeCustomizationInstance::CreateStatic(
		                                                &FGameplayTagCustomizationPublic::MakeInstance));
	PropertyModule.RegisterCustomPropertyTypeLayout(FUIActionTag::StaticStruct()->GetFName(),
	                                                FOnGetPropertyTypeCustomizationInstance::CreateStatic(
		                                                &FGameplayTagCustomizationPublic::MakeInstance));
}
