...
void FCommonVideoPlayerCustomization::CustomizeDetails(IDetailLayoutBuilder& DetailLayout)
{
	...
	TransportControlArgs.WidgetsToCreate.Emplace(
		FOnMakeTransportWidget::CreateSP(this, &FCommonVideoPlayerCustomization::HandleCreateMuteToggleWidget));
...
{
	static const FVolumeControlStyle VolumeStyle = FAppStyle::GetWidgetStyle<
		FVolumeControlStyle>(TEXT("VolumeControl"));
