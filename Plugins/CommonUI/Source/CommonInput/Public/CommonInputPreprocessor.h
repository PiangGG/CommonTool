...
protected:
	...
	bool InputMethodPermissions[static_cast<uint8>(ECommonInputType::Count)];

	// The reasons we might be filtering input right now.
	TMap<FName, bool> FilterInputTypeWithReasons[static_cast<uint8>(ECommonInputType::Count)];
