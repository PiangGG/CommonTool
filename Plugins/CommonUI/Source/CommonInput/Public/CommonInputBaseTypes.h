...
public:
	...
	UPROPERTY(EditDefaultsOnly, Category = "Gamepad",
		meta=(EditCondition="InputType == ECommonInputType::Gamepad", GetOptions = GetRegisteredGamepads))
	FName GamepadName;
...
public:
	...
	bool TryGetInputBrush(FSlateBrush& OutBrush, const TArray<FKey>& Keys, ECommonInputType InputType,
	                      const FName GamepadName) const;

	FName GetBestGamepadNameForHardware(FName CurrentGamepadName, FName InputDeviceName,
...
struct COMMONINPUT_API FCommonInputPlatformBaseData
{
	...
	virtual bool TryGetInputBrush(FSlateBrush& OutBrush, FKey Key, ECommonInputType InputType,
	                              const FName& GamepadName) const;
	virtual bool TryGetInputBrush(FSlateBrush& OutBrush, const TArray<FKey>& Keys, ECommonInputType InputType,
	                              const FName& GamepadName) const;
...
public:
	...
	COMMONINPUT_API static void GetCurrentPlatformDefaults(ECommonInputType& OutDefaultInputType,
