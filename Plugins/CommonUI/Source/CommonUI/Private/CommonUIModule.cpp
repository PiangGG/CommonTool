...
void FCommonUIModule::CreateUISettings()
{
	...
	CommonUIEditorSettings = NewObject<UCommonUIEditorSettings>(GetTransientPackage(),
	...
	if (SettingsModule != nullptr)
	{
		ISettingsSectionPtr SettingsSection = SettingsModule->RegisterSettings("Project", "Plugins", "CommonUI",
		                                                                       NSLOCTEXT("CommonUIPlugin",
			                                                                       "CommonUISettingsName",
			                                                                       "Common UI Framework"),
		                                                                       NSLOCTEXT("CommonUIPlugin",
			                                                                       "CommonUISettingsDescription",
			                                                                       "Configure Common UI Framework defaults."),
		                                                                       CommonUISettings);

		ISettingsSectionPtr EditorSettingsSection = SettingsModule->RegisterSettings(
			"Project", "Plugins", "CommonUIEditor",
		...
		SettingsModule->RegisterSettings(TEXT("Project"), TEXT("Plugins"), TEXT("CommonUIInputSettings"),
		                                 NSLOCTEXT("CommonUIPlugin", "CommonUIInputSettingsName",
		                                           "Common UI Input Settings"),
		                                 NSLOCTEXT("CommonUIPlugin", "CommonUIInputSettingsDescription",
		                                           "Establish project-wide UI input settings and action mappings."),
