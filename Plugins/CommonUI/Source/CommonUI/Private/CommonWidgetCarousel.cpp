...
void UCommonWidgetCarousel::BeginAutoScrolling(float ScrollInterval)
{
	...
	TickerHandle = FTSTicker::GetCoreTicker().AddTicker(
		FTickerDelegate::CreateUObject(this, &UCommonWidgetCarousel::AutoScrollCallback), ScrollInterval);
}
...
void UCommonWidgetCarousel::OnDescendantSelectedByDesigner(UWidget* DescendantWidget)
{
	...
	UWidget* SelectedChild = FindChildContainingDescendant(this, DescendantWidget);
	if (SelectedChild)
	{
