...
public:
	...
	virtual EProcessHoldActionResult ProcessHoldInput(ECommonInputMode ActiveInputMode, FKey Key,
...
protected:
	...
	{
		check(ActionRouterPtr.IsValid());
		return *ActionRouterPtr;
	}
...
{
public:
	virtual ~FActivatableTreeNode() override;

	virtual EProcessHoldActionResult ProcessHoldInput(ECommonInputMode ActiveInputMode, FKey Key,
	                                                  EInputEvent InputEvent) const override;
	...
	void AddInputPreprocessor(const TSharedRef<IInputProcessor>& InputPreprocessor,
...
protected:
	...
	void DebugDumpRecursive(FString& OutputStr, int32 Depth, bool bIncludeActions, bool bIncludeChildren,
...
{
public:
	static FActivatableTreeRootRef Create(UCommonUIActionRouterBase& OwningRouter,
