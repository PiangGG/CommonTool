...
void UCommonButtonGroupBase::OnWidgetAdded(UWidget* NewWidget)
{
	if (UCommonButtonBase* Button = Cast<UCommonButtonBase>(NewWidget))
	{
		...
		Button->OnButtonBaseDoubleClicked.AddUniqueDynamic(
			this, &UCommonButtonGroupBase::OnHandleButtonBaseDoubleClicked);
		...
		Button->OnButtonBaseLockDoubleClicked.AddUniqueDynamic(
			this, &UCommonButtonGroupBase::OnHandleButtonBaseLockDoubleClicked);
...
void UCommonButtonGroupBase::OnWidgetRemoved(UWidget* OldWidget)
{
	if (UCommonButtonBase* Button = Cast<UCommonButtonBase>(OldWidget))
	{
		...
		Button->OnButtonBaseLockDoubleClicked.RemoveDynamic(
			this, &UCommonButtonGroupBase::OnHandleButtonBaseLockDoubleClicked);

		Buttons.RemoveAll([Button](TWeakObjectPtr<UCommonButtonBase> Entry)
		{
			return Entry == Button || !Entry.IsValid();
		});
