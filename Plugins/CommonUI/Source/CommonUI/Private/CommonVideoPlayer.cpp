	...
	: Super(Initializer)
{
	static ConstructorHelpers::FObjectFinder<UMaterial>
		VideoPlayerMaterialFinder(TEXT("/CommonUI/VideoPlayerMaterial"));
...
void UCommonVideoPlayer::HandleMediaPlayerEvent(EMediaEvent EventType)
{
	...
	case EMediaEvent::PlaybackResumed:
		...
		if (MyImage)
		{
			MyImage->RegisterActiveTimer(
				0.f, FWidgetActiveTimerDelegate::CreateUObject(this, &UCommonVideoPlayer::HandlePlaybackTick));
		}
		break;
