...
{
	UCommonActivatableWidget* OwningActivatableWidget = CommonUIUtils::GetOwningUserWidget<
		UCommonActivatableWidget>(this);
	...
	if (GetOwningActivatableWidget() != OwningActivatableWidget)
	{
		...
		{
			OwningActivatableWidget->OnActivated().AddUObject(
				this, &UCommonActivatableWidgetSwitcher::HandleOwningWidgetActivationChanged, true);
			OwningActivatableWidget->OnDeactivated().AddUObject(
				this, &UCommonActivatableWidgetSwitcher::HandleOwningWidgetActivationChanged, false);
