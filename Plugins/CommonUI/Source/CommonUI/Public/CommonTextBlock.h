...
protected:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Getter, Setter, Category = "Mobile",
...
private:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = CommonText,
	...
	UPROPERTY(
		meta = (DeprecatedProperty, DeprecationMessage =
			"bDisplayAllCaps is deprecated. Please use TextTransformPolicy instead."))
