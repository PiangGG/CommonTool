...
public:
	...
	FCommonButtonMetaData(const UCommonButtonBase& InOwningCommonButtonInternal): OwningCommonButton(
		&InOwningCommonButtonInternal)
	{
	}
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FCommonSelectedStateChangedBase, class UCommonButtonBase*, Button, bool,
                                             Selected);
...
class UCommonButtonBase : public UCommonUserWidget
{
	...
	COMMONUI_API void SetInputActionProgressMaterial(const FSlateBrush& InProgressMaterialBrush,
...
protected:
	...
	COMMONUI_API virtual void OnWidgetRebuilt() override;
	COMMONUI_API virtual void PostLoad() override;
	COMMONUI_API virtual void SynchronizeProperties() override;
	COMMONUI_API virtual FReply
	NativeOnFocusReceived(const FGeometry& InGeometry, const FFocusEvent& InFocusEvent) override;
    ...
    */
	...
	COMMONUI_API virtual void
	NativeOnMouseEnter(const FGeometry& InGeometry, const FPointerEvent& InMouseEvent) override;
	 ...
	 */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Setter, Category = Sound,
		meta = (DisplayName = "Pressed Sound Override"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Setter, Category = Sound,
		meta = (DisplayName = "Selected Hovered Sound Override"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Setter, Category = Sound,
		meta = (DisplayName = "Locked Pressed Sound Override"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Setter, Category = Sound,
		meta = (DisplayName = "Locked Hovered Sound Override"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Input|Hold",
		meta = (EditCondition="bRequiresHold", ExposeOnSpawn = true))
...
public:
	 ...
	 */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = Input,
		meta = (ExposeOnSpawn = true, RowType = "/Script/CommonUI.CommonInputActionDataBase"))
	 ...
	 */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = Input,
		meta = (EditCondition = "CommonInput.CommonInputSettings.IsEnhancedInputSupportEnabled", EditConditionHides))
...
protected:
	UPROPERTY(BlueprintAssignable, Category = "Events",
		meta = (AllowPrivateAccess = true, DisplayName = "On Selected Changed"))
	...
	UPROPERTY(BlueprintAssignable, Category = "Events",
		meta = (AllowPrivateAccess = true, DisplayName = "On Double Clicked"))
	...
	UPROPERTY(BlueprintAssignable, Category = "Events",
		meta = (AllowPrivateAccess = true, DisplayName = "On Unhovered"))
	FCommonButtonBaseClicked OnButtonBaseUnhovered;

	UPROPERTY(BlueprintAssignable, Category = "Events",
		meta = (AllowPrivateAccess = true, DisplayName = "On Lock Clicked"))
	FCommonButtonBaseClicked OnButtonBaseLockClicked;

	UPROPERTY(BlueprintAssignable, Category = "Events",
		meta = (AllowPrivateAccess = true, DisplayName = "On Lock Double Clicked"))
...
private:
	...
	template <typename>
	friend class SCommonButtonTableRow;
