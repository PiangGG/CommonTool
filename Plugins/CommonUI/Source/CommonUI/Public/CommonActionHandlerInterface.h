...
struct FCommonInputActionHandlerDelegateData
{
	...
	FCommonInputActionHandlerDelegateData(const FDataTableRowHandle& InInputActionRow,
...
class ICommonActionHandlerInterface
{
	...
	virtual bool HandleTouchInput(uint32 TouchId, ETouchType::Type TouchType, const FVector2D& TouchLocation,
	                              bool& bPassThrough) = 0;
	 ...
	 */
	virtual void TriggerFirstMatchingInputAction(int32 ControllerId,
