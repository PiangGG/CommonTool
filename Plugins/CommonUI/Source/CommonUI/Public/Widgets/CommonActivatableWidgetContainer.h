...
public:
	                              ...
	                              TFunctionRef<void(ActivatableWidgetT&)> InstanceInitFunc)
	{
		...
		if (ActivatableWidgetClass && ActivatableWidgetClass->IsChildOf<ActivatableWidgetT>())
		{
			return Cast<ActivatableWidgetT>(AddWidgetInternal(ActivatableWidgetClass,
			                                                  [&InstanceInitFunc](
			                                                  UCommonActivatableWidget& WidgetInstance)
			                                                  {
				                                                  InstanceInitFunc(
					                                                  *CastChecked<ActivatableWidgetT>(
						                                                  &WidgetInstance));
			                                                  }));
		}
		return nullptr;
	...
	DECLARE_EVENT_TwoParams(UCommonActivatableWidgetContainerBase, FTransitioningChanged,
...
private:
	...
	UCommonActivatableWidget* AddWidgetInternal(TSubclassOf<UCommonActivatableWidget> ActivatableWidgetClass,
