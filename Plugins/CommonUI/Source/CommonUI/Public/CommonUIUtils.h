...
namespace CommonUIUtils
{
	...
	{
		static_assert(TIsDerivedFrom<UserWidgetT, UUserWidget>::IsDerived,
		              "CommonUIUtils::GetOwningUserWidgetTyped can only search for UUserWidget types");
	 ...
	 *
	 */
	COMMONUI_API void ValidateBoundWidgetHierarchy(const UWidgetTree& WidgetTree, IWidgetCompilerLog& CompileLog,
	...
	{
		ValidateBoundWidgetHierarchy(WidgetTree, CompileLog, CollisionPolicy, ParentWidgetName,
		                             TArray<FName>{ChildNames...});
	}
#endif
};
