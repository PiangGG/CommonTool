...
public:
	...
	void Construct(const FArguments& InArgs, const TSharedRef<STableViewBase>& InOwnerTableView,
	               UUserWidget& InChildWidget, UListViewBase* InOwnerListView)
	{
		...
		if (ensureMsgf(CommonButton,
		               TEXT(
			               "The widget object attached to an SCommonButtonTableRow is always expected to be a UCommonButtonBase."
		               )))
		{
			...
			CommonButton->SetIsToggleable(
				SelectionMode == ESelectionMode::SingleToggle || SelectionMode == ESelectionMode::Multi);
